...
class ServerActionsTest(unittest.TestCase):
    resize_available = nova.config.OpenStackConfig().env.resize_available
    
    @classmethod
    def setUpClass(cls):
        cls.os = openstack.Manager()
        cls.client = cls.os.servers_client
        cls.config = nova.config.OpenStackConfig()
    ...
    def test_change_server_password(self):
        """ The server's root password should be set to the provided password """
